<template>
    <div class="chartcon" :id='rightbarlinechart'></div>
</template>
          ...
          tooltip: {
            ...
            formatter: function(param){
              ...
              return html +='<div style="position:relative;padding:10px 13px;background:#fff;border:1px solid #d7e8fd;border-radius:5px;font-size:12px;color:#7a7a7a;line-height:26px;box-shadow:0 0 10px 0 rgba(6,115,242,.4);">'+
                '<p>2017年'+param[0].name+'新注册企业注册资本：</p>'+
                '<p><span style="font-size:16px;color:#fd7e23;font-weight:bold;">'+param[0].value+'</span>万元<span style="font-size:16px;color:#fd7e23;margin-left:20px;font-weight:bold;">'+param[1].value+'%</span>增长率</p>'+

                '<i style="position:absolute;bottom:-23px;left:70px;width:0;height:0;border:12px solid transparent;border-top:11px solid #d7e8fd;"></i>'+
                '<i style="position:absolute;bottom:-20px;left:72px;width:0;height:0;border:10px solid transparent;border-top:10px solid #fff;"></i>'+
                '</div>'
            }
          },
          calculable: true,
